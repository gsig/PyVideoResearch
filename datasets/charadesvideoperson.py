...
from charades import _cls2int, default_loader
from charadesvideo import CharadesVideo
...
class CharadesVideoPerson(CharadesVideo):
    ...
    def prepare(self, path, labels, split):
        print('CharadesVideoPerson prepare')
        datadir = path
        datas = []
