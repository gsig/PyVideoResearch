...
class CharadesVideo128(Charades):
    def __init__(self, *args, **kwargs):
        self.trainGAP = 128
        self.testGAP = 15
        self.inputsize = 224
        super(CharadesVideo128, self).__init__(*args, **kwargs)
