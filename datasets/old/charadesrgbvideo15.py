...
class CharadesVideo15(Charades):
    def __init__(self, *args, **kwargs):
        self.trainGAP = 64
        self.testGAP = 15
        self.inputsize = kwargs['inputsize']
        super(CharadesVideo15, self).__init__(*args, **kwargs)
