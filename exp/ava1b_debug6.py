...
args = [
    ...
    '--dataset', 'ava_mp4',
    '--arch', 'aj_i3d',
    '--wrapper', 'frcnn_wrapper',
    '--criterion', 'frcnn_criterion',
    '--metrics', 'frcnn_metric;frcnn_metric2;frcnn_metric3;frcnn_metric4;frcnn_metric5;frcnn_map_metric;frcnn_metric6',
    #'--lr', '2.5e-2',
    '--lr', '3.75e-4',
    '--lr-decay-rate', '50',
    '--epochs', '120',
    ...
    #'--resume', '/nfs.yoda/gsigurds/ai2/caches/ava1b_debug2/model.pth.tar',
    #'--evaluate',
    '--workers', '6',
    '--no-val-video',
    '--metric', 'AVAval',
