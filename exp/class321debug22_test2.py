...
args = [
    ...
    '--tasks', 'actor_observer_classification_task',
    '--actor-observer-classification-task-dataset', 'charades_ego_only_first',
    '--criterion', 'actor_observer_with_softmax_criterion',
    '--train-file', '/nfs.yoda/gsigurds/CharadesEgo_v1_train.csv;/nfs.yoda/gsigurds/Charades_v1_train.csv',
    '--val-file', '/home/gsigurds/actor-observer/datasets/labels/CharadesEgo_v0_egocentric_test.csv;/nfs.yoda/gsigurds/Charades_v1_test.csv',
    '--data', '/scratch/gsigurds/CharadesEgo_v1_rgb/;/scratch/gsigurds/Charades_v1_rgb/',
    '--pretrained',
    '--resume', '/nfs.yoda/gsigurds/caches/class321debug22/model.pth.tar',
    '--decay', '0.95',
    '--lr', '1e-5',
