...
args = [
    ...
    '--train-file', '/nfs.yoda/gsigurds/CharadesEgo_v06_train.csv;/nfs.yoda/gsigurds/Charades_v1_train.csv',
    '--val-file', '/nfs.yoda/gsigurds/CharadesEgo_v06_test.csv;/nfs.yoda/gsigurds/Charades_v1_test.csv',
