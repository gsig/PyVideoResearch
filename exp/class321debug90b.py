...
args = [
    ...
    '--train-file', '/nfs.yoda/gsigurds/CharadesEgo_v09b_train.csv;/nfs.yoda/gsigurds/Charades_v1_train.csv',
    '--val-file', '/nfs.yoda/gsigurds/CharadesEgo_v09_test.csv;/nfs.yoda/gsigurds/Charades_v1_test.csv',
