...
args = [
    ...
    '--print-freq', '1',
    '--dataset', 'charades_video_x3',
    '--arch', 'resnet50_3d_nonlocal_nobn',
    '--criterion', 'default',
    '--wrapper', 'default',
    ...
    '--resume', '/nfs.yoda/gsigurds/ai2/caches/' + __file__.split('/')[-1].split('.')[0] + '/model.pth.tar'+';'+'/nfs.yoda/gsigurds/ai2/caches/i3d8l/model_best.pth.tar',
    #'--start-epoch', '1',
    #'--evaluate',
    '--workers', '4',
    #'--workers', '0',
