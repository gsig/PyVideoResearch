...
class InceptionI3d(nn.Module):
    ...
    def __init__(self, num_classes=400, spatial_squeeze=True,
        ...
        end_point = 'nl_3b'
        self.end_points[end_point] = NONLocalBlock3D(192, group_size=4)
        if self._final_endpoint == end_point: return
        ...
        end_point = 'nl_3c'
        self.end_points[end_point] = NONLocalBlock3D(256, group_size=4)
        if self._final_endpoint == end_point: return
        ...
        end_point = 'nl_4c'
        self.end_points[end_point] = NONLocalBlock3D(192+208+48+64)
        if self._final_endpoint == end_point: return
        ...
        end_point = 'nl_4d'
        self.end_points[end_point] = NONLocalBlock3D(160+224+64+64)
        if self._final_endpoint == end_point: return
        ...
        end_point = 'nl_4e'
        self.end_points[end_point] = NONLocalBlock3D(128+256+64+64)
        if self._final_endpoint == end_point: return
...
class AJ_I3D_NL_Grp(Base):
    @classmethod
    def get(cls, args):
        #model = InceptionI3d(400, in_channels=3)
        model = InceptionI3d(157, in_channels=3, dropout_keep_prob=0.3)
