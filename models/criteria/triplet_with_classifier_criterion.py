...
from models.criteria.triplet_criterion import TripletCriterion
...
class TripletWithClassifierCriterion(TripletCriterion):
    def __init__(self, args):
        super(TripletWithClassifierCriterion, self).__init__(args)
